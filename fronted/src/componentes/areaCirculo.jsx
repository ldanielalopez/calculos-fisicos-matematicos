...
function AreaCirculo() {
    ...
    const calcularAreaCirculo = async() => {
        ...
        fetch ("http://localhost:3000/matematicas/areaCirculo", {          // indicamos la ruta que vamos a consumir
    ...
    return (
        <div className="bg-white p-10 rounded-2xl shadow-xl border border-slate-100 w-full max-w-xl mx-auto mt-10">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Calcular Área de Círculo</h2>
            <hr className="border-slate-200 my-3" />
            <div className="space-y-6">
                <div>
                    <input
                        type="number"
                        placeholder="Ingrese el valor del radio"
