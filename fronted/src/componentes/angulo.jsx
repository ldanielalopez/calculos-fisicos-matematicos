...
function Angulo() {
    ...
    const calcularAngulo = async() => {
        ...
        fetch ("http://localhost:3000/matematicas/angulo", {          // indicamos la ruta que vamos a consumir
    ...
    return (
        <div className="bg-white p-10 rounded-2xl shadow-xl border border-slate-100 w-full max-w-xl mx-auto mt-10">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Calcular Ángulo</h2>
